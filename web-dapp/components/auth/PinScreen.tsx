...
export function PinScreen() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/40 backdrop-blur-md px-4">
      <div className="bg-white/90 border border-white/50 shadow-2xl rounded-3xl p-8 w-full max-w-sm text-center flex flex-col items-center">
        ...
        <div className="grid grid-cols-3 gap-x-6 gap-y-4 mb-8">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(num => (
            <button
              ...
              className="w-16 h-16 rounded-full bg-slate-50 hover:bg-slate-100 active:bg-slate-200 text-2xl font-semibold text-slate-800 transition-colors shadow-sm flex items-center justify-center"
            >
              {num}
            </button>
          ))}
          ...
          <button
            ...
            className="w-16 h-16 rounded-full text-slate-600 hover:bg-slate-100 active:bg-slate-200 transition-colors flex items-center justify-center disabled:opacity-50"
          >
        ...
        {mode === "unlock" && (
          <button 
            ...
            className="flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-red-600 transition-colors mt-2"
          >
