...
export function NotificationBell() {
  ...
  return (
    ...
    >
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute -right-2 sm:right-0 top-full mt-2 w-[calc(100vw-2rem)] max-w-[340px] sm:w-80 bg-white rounded-2xl shadow-xl border border-slate-100 z-50 overflow-hidden animate-in fade-in slide-in-from-top-1 duration-150">
          {/* Header */}
