...
CIVIC_REFERENCE_TEXTS = {
    ...
    "Drainage / Sewage": [
        ...
        "A civic report about clogged or overflowing public toilets, sewer blockages in public restrooms, or wastewater leaks in washrooms.",
    ],
    "Water Supply": [
    ...
    "Public Property Damage": [
        ...
        "A civic report about damaged public washrooms, vandalized restrooms, broken toilet fixtures, damaged sinks, or unusable public lavatories.",
        "A complaint about broken toilet doors, malfunctioning flush mechanisms, leaking faucets, or damaged sanitary facilities in parks, universities, or public buildings.",
    ],
    "Traffic / Road Safety": [
    ...
    "General Civic Issue": [
        ...
        "A public health and sanitation report regarding dirty, unhygienic, clogged, or unmaintained public restrooms and municipal washrooms.",
        "A civic complaint about unsanitary public toilets, lack of running water or soap in public washrooms, or foul restroom odors.",
    ],
}
